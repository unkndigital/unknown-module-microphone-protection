...
Requires these enabled modules: privacy-protection.

## Disable, Restore and Limits

Enable Privacy Protection and its voice control first. Disabling restores owned capture-node overlays, retaining your preference for later re-enabling. Hardware switches, proprietary driver paths, early boot and hotplug gaps are not guaranteed covered. Unsupported or active capture devices fail without forced mutation.
